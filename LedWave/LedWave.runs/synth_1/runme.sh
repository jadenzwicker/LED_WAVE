...
HD_PWD='D:/LED_WAVE/LedWave/LedWave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedWave_BASYS3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedWave_BASYS3.tcl
