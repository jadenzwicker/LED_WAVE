...
HD_PWD='D:/LED_WAVE/LedWave/LedWave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LedWave_BASYS3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LedWave_BASYS3.tcl -notrace
